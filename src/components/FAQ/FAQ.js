    ...
    <div className={`faq-container ${showFAQ ? 'show' : ''}`}>
      <div className="faq-popup">
        ...
        <div className="faq-content">
          ...
          <p>WHAT IS THE TIMING OF THE CAMPAIGN?</p>
          ...
          <p>WHAT’S THE DEAL WITH PLASTIC POLLUTION IN OUR WATER?</p>
          ...
          We recommend you start by telling someone else about the mission, why you’re passionate about it, and invite them to get involved at #OceanGaurdians. We also encourage you to engage with and amplify #OceanGaurdians content across the internet. We think you’ll be surprised at who else is on #TeamSeas and how many fascinating videos are out there for you to discover. As the campaign develops, we hope you’ll co-create it with us as we rally toward our shared 30M goal. One of the most exciting parts for us is that we have no idea what you’ll come up with, and we can’t wait to see it.</p>
          <p>HOW ARE WE ACTUALLY GOING TO CLEAN UP ALL THIS TRASH?</p>
